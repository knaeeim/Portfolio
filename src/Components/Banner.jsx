...
const Banner = () => {
    return (
        <div
            id="Home"
            className="py-20 px-5 md:px-0 flex flex-col-reverse md:flex-row justify-center items-center gap-10">
            {/* text div */}
            <div data-aos="fade-right" className="md:w-[60%] space-y-3">
                ...
                <p className="text-lg text-gray-400 mt-3 w-[75%]">
            ...
            <motion.div
                ...
                <img
                    src={naeeim}
                    className="md:h-[500px] h-[450px] rounded-2xl object-cover shadow-lg"
                    alt="Profile"
                />
            </motion.div>
        </div>
