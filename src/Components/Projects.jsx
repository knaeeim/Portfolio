        ...
        <div id="Project" className="py-20 px-5 md:px-0">
            ...
            <div className="flex flex-col md:flex-row justify-evenly items-center mt-16">
                ...
                <div
                    ...
                    <img
                        className="hover:scale-105 transition duration-300 h-[400px] object-cover"
                        src={images[0]}
                        alt=""
                    />
                </div>
                ...
                <div
                    data-aos="fade-left"
                    className="md:w-[43%] w-full md:pl-10 pt-10 md:pt-0">
                    <h2 className="text-3xl font-semibold">
                        Project Name:{" "}
                        <span className="text-blue-500">Khaddo Sheba</span>
                    </h2>
                    <p className="text-lg text-gray-700 text-justify mt-5">
                        This is a complete full-stack food donation platform
                        that connects food donors and requesters. The project
                        provides a smooth user experience, efficient food
                        management system, and secure private routes. The goal
                        is to help reduce food waste and promote sharing through
                        a modern, responsive, and recruiter-friendly web
                        application.
                    </p>
                    <p className="text-lg text-gray-700 text-justify mt-5">
                    ...
                    <div className="flex md:flex-nowrap flex-wrap justify-start items-center gap-2 mt-10">
                        <a
                            href="https://github.com/knaeeim/KhaddoShbea-Client"
                            target="_blank"
                            className="ml-5 btn">
                            View Client Code
                        </a>
                        <a
                            href="https://github.com/knaeeim/Khaddo-Sheba-Server"
                            target="_blank"
                            className="ml-5 btn bg-pink-600 text-white">
                            View Server Code
                        </a>
                        <a
                            href="https://assignment-11-e46ad.web.app/"
                            target="_blank"
                            className="ml-5 btn">
                            Live Link
                        </a>
            ...
            <div className="flex flex-col md:flex-row-reverse justify-evenly items-center md:mt-32 mt-24">
                {/* image carousel */}
                <div
                    data-aos="fade-left"
                    className="md:w-[43%] w-full flex justify-between items-center rounded-2xl overflow-hidden">
                ...
                <div
                    data-aos="fade-right"
                    className="md:w-[43%] w-full md:pr-10 pt-10 md:pt-0">
                    <h2 className="text-3xl font-semibold">
                        Project Name:{" "}
                    ...
                    <div className="flex md:flex-nowrap flex-wrap justify-start items-center gap-5 mt-10">
                        <a
                            href="https://github.com/knaeeim/flexlance"
                            className="ml-5 btn"
                            target="_blank">
                            View Client Code
                        </a>
                        <a
                            href="https://github.com/knaeeim/flexlance-server"
                            className="ml-5 btn bg-pink-600 text-white"
                            target="_blank">
                            View Server Code
                        </a>
                        <a
                            href="https://flexlance-auth.web.app/"
                            className="ml-5 btn"
                            target="_blank">
                            Live Link
                        </a>
            ...
            <div className="flex flex-col md:flex-row justify-evenly items-center md:mt-32 mt-24">
                {/* image carousel */}
                <div
                    data-aos="fade-right"
                    className="md:w-[43%] w-full flex justify-between items-center rounded-2xl overflow-hidden">
                ...
                <div
                    ...
                    <div className="flex md:flex-nowrap flex-wrap justify-start items-center gap-5 mt-10">
                        <a
                            href="https://github.com/knaeeim/docTime-Pro"
                            target="_blank"
                            className="ml-5 btn">
                            View Client Code
                        </a>
                        ...
                        <a
                            href="https://doctime-pro-updated.netlify.app/"
                            className="ml-5 btn"
                            target="_blank">
                            Live Link
                        </a>
                    ...
                    <dialog id="my_modal_2" className="modal">
                        <div className="modal-box">
                            ...
                            <p className="py-4">
                                This Project has no different repo for Server
                                Code.
                                <br />
                                You will find the server code in the client
                                repo.
                            </p>
